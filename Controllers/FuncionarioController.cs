...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Criar(Funcionario funcionario)
    {
        ...
        tableClient.UpsertEntity(funcionarioLog); // Salva no Azure
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        tableClient.UpsertEntity(funcionarioLog); // Salva no Azure Table Storage
    ...
    public IActionResult Deletar(int id)
    {
        ...
        _context.Funcionarios.Remove(funcionarioBanco); // Deleta a entidade
        _context.SaveChanges();
